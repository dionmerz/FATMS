...
import edu.uw.tacoma.dionmerz.fatms.listView.OutboundItineraryFragment.OnListFragmentInteractionListener;
...
public class MyItineraryRecyclerViewAdapter extends RecyclerView.Adapter<MyItineraryRecyclerViewAdapter.ViewHolder> {
    ...
    public MyItineraryRecyclerViewAdapter(List<Itinerary> items, OnListFragmentInteractionListener listener) {
